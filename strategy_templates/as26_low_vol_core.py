# -*- coding: utf-8 -*-
"""A股低波动核心 (as26_low_vol_core)

[A股] 20 日波动率<1.8%、Beta<0.9、市值 100 亿以上，低波动异象的 A 股实现。
