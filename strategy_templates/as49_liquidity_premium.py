# -*- coding: utf-8 -*-
"""A股流动性溢价 (as49_liquidity_premium)

[A股] 成交额 5 亿以上、市值 200 亿以上、量比不低于 0.8 的高流动性组合。
...
STRATEGY_CONFIG = {
    ...
    "kwargs": {
        ...
        "n_drop": 8,
        "rebalance_days": 5,
        "f_amount_ma_5_min": 50000,
        "f_total_mv_min": 20000000000.0,
        "f_vol_to_ma20_min": 0.8,
        "f_pe_ttm_max": 80,
    },
}
