# -*- coding: utf-8 -*-
"""A股月度动量先锋 (as16_momentum_20)

[A股] 模型分融合 20 日动量，持仓 30 只、3 日调仓，是最经典的横截面动量轮动。
