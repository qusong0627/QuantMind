# -*- coding: utf-8 -*-
"""A股季度动量 (as17_momentum_60)

[A股] 以 60 日动量为主、模型分辅助的季度级轮动，换手明显低于月度版本。
