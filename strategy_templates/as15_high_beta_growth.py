# -*- coding: utf-8 -*-
"""A股高弹性成长 (as15_high_beta_growth)

[A股] Beta 在 1.0 至 2.5 之间、流动性充足的高弹性组合，仓位 80% 控制回撤。
