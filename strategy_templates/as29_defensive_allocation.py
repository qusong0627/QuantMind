# -*- coding: utf-8 -*-
"""A股防御配置 (as29_defensive_allocation)

[A股] Beta<0.8、股息率>1.5%、流动性充足的防御组合，基础仓位 85%。
