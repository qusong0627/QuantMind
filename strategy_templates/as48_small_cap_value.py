# -*- coding: utf-8 -*-
"""A股小盘价值 (as48_small_cap_value)

[A股] 市值 300 亿以下、PE<25、PB<2.5、有分红的低估值小盘，双周调仓。
