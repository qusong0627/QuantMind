...
STRATEGY_CONFIG = {
    ...
    "kwargs": {
        ...
        "n_drop": 12,
        "rebalance_days": 3,
        "f_volume_trend_3d_min": 0.2,
        "f_vol_to_ma5_min": 1.1,
