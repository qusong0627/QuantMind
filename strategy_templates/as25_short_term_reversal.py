...
STRATEGY_CONFIG = {
    ...
    "kwargs": {
        ...
        "n_drop": 15,
        "rebalance_days": 3,
        "f_pct_change_max": 0.0,
        "f_rsi_6_max": 40,
        "f_ma_gap_20_min": -10.0,
