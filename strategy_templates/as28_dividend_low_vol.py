# -*- coding: utf-8 -*-
"""A股红利低波 (as28_dividend_low_vol)

[A股] 股息率>2.5% + 波动率<2.2% + PE<25，月度调仓，最经典的防守型组合。
