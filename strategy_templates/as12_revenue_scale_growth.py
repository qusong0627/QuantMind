# -*- coding: utf-8 -*-
"""A股营收扩张 (as12_revenue_scale_growth)

[A股] 要求 TTM 营收 10 亿以上且 PS<15，寻找已有收入体量、尚未被过度定价的成长标的。
