...
import { Award, BarChart3, LibraryBig, Sparkles } from 'lucide-react';
...
type SkillsTab = 'prompts' | 'factor-report' | 'templates' | 'eval';
        ...
        <header className={PAGE_LAYOUT.headerClass} style={{ height: `${PAGE_LAYOUT.headerHeight}px` }}>
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex items-center gap-2.5 ml-1 min-w-0">
              ...
              <span className="text-sm font-medium text-slate-500 truncate">提示词库 · 报告档案 · 因子报告 · 策略模板 · 评估中心</span>
            </div>
          </div>
